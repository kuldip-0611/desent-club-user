    ...
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
      <div>
        <div className="flex items-center gap-3">
          <Image src="/logo.png" alt="Desent Club logo" width={30} height={30} className="rounded-md" />
          <p className="text-lg font-semibold tracking-[0.15em] text-white">DESENT CLUB</p>
        </div>
